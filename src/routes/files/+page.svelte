    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-5">
        ...
        <div class="bg-[#191919] rounded p-3 md:p-5 text-white/70">
            <div class="flex justify-between items-center">
                ...
                <a href={item.url} target="_blank" class="p-2 md:p-1.5 px-8 md:px-10 bg-[#222222] rounded text-sm md:text-base font-thin transition-all duration-300">Download</a>
            </div>
        </div>
        {:else}
        <div class="bg-[#191919] rounded p-3 md:p-5 text-white/70">
